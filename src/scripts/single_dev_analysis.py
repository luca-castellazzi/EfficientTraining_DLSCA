...
def main():
    ...
    # Save GEs as .CSV
    ge_file_path = constants.RESULTS_PATH + f'/1d/ge-{train_dev}vs{test_dev}.csv'
    ges_to_csv(ges, config_labels, ge_file_path)
    
    # Plot GEs
    ge_plot_path = constants.RESULTS_PATH + f'/1d/ge-{train_dev}vs{test_dev}.png'
    ...
    s_plot_path = constants.RESULTS_PATH + f'/1d/scores-{train_dev}vs{test_dev}.png'
