...
def kfold_crossval(x_train, y_train, key_bytes_train, true_kb_train):
...
def final_scores(ges):
    ...
    scores = [ge_score(ge) for ge in ges]
...
def main():
    ...
    best_hp = kfold_crossval(x_train, y_train, key_bytes_train, true_kb_train)
