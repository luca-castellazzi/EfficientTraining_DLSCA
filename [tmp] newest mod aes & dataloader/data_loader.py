...
class DataLoader():
    ...
    def __init__(self, trace_files, tot_traces, label_fn, start_tr_idx=0, byte_idx=None, 
    ...
    def _retrieve_metadata(self, tr):
        ...
        l = self.label_fn(p, k) # Compute the set of 16 labels
...
class SplitDataLoader(DataLoader):
    ...
    def __init__(self, trace_files, tot_traces, train_size, label_fn, start_tr_idx=0, 
        ...
        super().__init__(trace_files, tot_traces, label_fn, start_tr_idx, byte_idx,
